...
const deletePost = (id) => {
    ...
    if (JSON.parse(localStorage[id])) {
        ...
        <div class=" font-bold  self-center dark:text-salad">Are you sure to delete this post?</div>
        <div class="rounded-2xl p-4 m-2 bg-salad dark:bg-gray">
            <div class="flex flex-row justify-between align-middle">
                <div class="flex flex-row align-middle justify-start">
                    <img class="inline" height="80" width="80" src="./assets/user.png">
                    <h2 class="username inline self-center text-green overflow-hidden dark:text-salad">${users[posts[id].userId].name}</h2>
                </div>
                <div class="flex align-middle flex-row justify-end my-4 space-x-3 mr-2">
                    <div class="star w-8 h-8 self-center">
                        <img class="active-star w-8 h-8 self-center" src="./assets/chosen.png" alt="added to favotites" hidden>
                        <img class="simple w-8 h-8 self-center" src="./assets/simple.png" alt="not added to favorites">
                    </div>
            ...
            <h1 class="title text-center text-2xl pb-5 text-green dark:text-salad">${posts[id].title}</h1>
            <h2 class="body text-green dark:text-salad">${posts[id].body}</h2>
        </div>
        `;
...
const addPost = async (postData) => {
    ...
    post.classList.add('delay-0');
    post.classList.add('hover:scale-100');
    ...
    post.innerHTML =
		`<div class="rounded-2xl p-4 m-2 bg-salad dark:bg-gray">
            <div class="flex flex-row justify-between align-middle">
                <div class="flex flex-row align-middle justify-start">
                    <img class="inline" height="80" width="80" src="./assets/user.png">
                    <h2 class="username inline self-center text-green overflow-hidden dark:text-salad">${users[postData.userId].name}</h2>
                </div>
                <div class="star w-fit h-fit self-center">
                    <img class="active-star w-8 self-center" src="./assets/chosen.png" alt="added to favotites" hidden>
                    <img class="afk-star w-8 self-center" src="./assets/simple.png" alt="not added to favorites">
                </div>
            </div>
            <h1 class="title text-center text-2xl pb-5 text-green dark:text-salad">${postData.title}</h1>
            <h2 class="body text-green dark:text-salad">${postData.body}</h2>
